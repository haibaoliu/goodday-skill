...
| `other-review` | 他者审查 | 独立子Agent审查，v2.1 自反驳+正面肯定 |
...
#### other-review — 他者审查 v2.1

独立子 Agent 审查主 Agent 产出，v2.1 新增自反驳机制（每个 finding 需先自我反驳再报告）+ 强制正面肯定（"做得好的地方"）。支持多模型共识。审查维度：code/security/logic/completeness/correctness/design。严格度：gentle/normal/strict/adversarial。触发词：审查/检查/review/找问题/audit/critique。
